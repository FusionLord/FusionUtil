...
public class TexturedQuadDrawer implements IQuadDrawer
{
	...
	public void draw(int x, int y, int drawWidth, int drawHeight)
	{
		...
		tessellator.getWorldRenderer().addVertexWithUV(x, y + drawHeight, zLevel, u0, v0);
		tessellator.getWorldRenderer().addVertexWithUV(x + drawWidth, y + drawHeight, zLevel, u1, v1);
		tessellator.getWorldRenderer().addVertexWithUV(x + drawWidth, y, zLevel, u2, v2);
		tessellator.getWorldRenderer().addVertexWithUV(x, y, zLevel, u3, v3);
		tessellator.draw();
	}
